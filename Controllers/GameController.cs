...
public sealed class GameController : MonoBehaviour
{
   ...
   // private List<CreateBonus.BonusPos> _bonusList = CreateBonus._bonusPos;
    ...
    private void Awake()
    {
        //foreach (var bonusinlist in _bonusList)
        {
            //Instantiate(bonusinlist.BonusPrefab, new Vector3(bonusinlist.x, bonusinlist.y, bonusinlist.z), Quaternion.identity);
        }
